...
describe('fizzbuzz', function() {
	...
	describe('#message(from, to)', function() {
		...
		it('should return the expected string for the first 20 numbers', function() {
			assert.equal('1 2 lucky 4 buzz fizz 7 8 fizz buzz 11 fizz lucky 14 fizzbuzz 16 17 fizz 19 buzz ', fizzbuzz.createMessage(1, 20));
		});
		
		it('should return the expected string for the numbers 21 through 25', function() {
			assert.equal('fizz 22 lucky fizz buzz ', fizzbuzz.createMessage(21, 25));
		});
	});
})
